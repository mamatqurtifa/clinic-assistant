...
2. Di dalam repository tersebut, buat 3 file baru persis dengan nama di bawah, dan _copy-paste_ kode ke masing-masing file:
...
```json
{
  ...
  "version": "2.0.0",
  "description": "Proxy backend Express.js untuk booking konsultasi dokter via Google Calendar API. Setiap user login dengan akun Google sendiri — refresh token disimpan di sisi klien, bukan di server.",
  "main": "index.js",
  "scripts": {
    "start": "node index.js",
...
_(Ubah alamat email dummy di atas dengan alamat email asli para dokter)_
...
6. _Copy_ seluruh isi teks dari notepad tadi, lalu _paste_ langsung ke kotak pertama pada bagian **Environment Variables**. Vercel akan otomatis mengenali dan memasukkan ke-9 variabel tersebut sekaligus!
...
2. Setup **Persona** di tab persona (_sidebar_ sebelah kiri). Di sini kamu juga bisa mengatur atau menyesuaikan _photo profile_ bot kamu.
3. _Copy_ kode _workflow_ di bawah ini:
  ...
  "nodes": [
    {
      ...
      "properties": {
        ...
        "variables": [
          ...
          {
            "var_key": "refresh_token",
            "data_type": "string",
            "persist": false,
            "var_value": "{{refresh_token}}"
          }
        ],
        "decription": "",
        "description": ""
    ...
    },
    {
      ...
      "properties": {
        ...
        "entities_schema": [
          {
            "name": "email",
            "example": ["example@gmail.com", "aku@gmail.com"],
    ...
    },
    {
      ...
      "properties": {
        ...
        "entities_schema": [
          ...
          {
            "name": "eventId",
            "example": ["d797qs6uijlro4v7i6ou2c0iv0"],
        ...
        "conditions": [
          {
            ...
            "source_value": "{{node_output.response_body.login_status}}",
            "compared_value": "failed"
          }
        ],
        "description": ""
      },
    ...
    },
    {
      ...
      "properties": {
        "url": "https://clinic-assistant-zeta.vercel.app/api/auth/check",
        "body": [],
        "label": "Check Auth",
        "method": "GET",
        "headers": {
    ...
    },
    {
      ...
      "type": "response-formatter",
      "position": {
        "x": -143.46130231718206,
        "y": 116.27638326668523
      },
      "properties": {
        ...
        "response_format": {
          "default": [
            ...
            {
              "mode": "manual_setup",
              "text": "Waduh, sepertinya kamu belum login 😅\n\nUntuk melanjutkan, silakan buka link berikut terlebih dahulu:\n\n{{node_output.response_body.login_url}}\n\nSetelah halaman login terbuka, silakan salin *token* yang tersedia. Kemudian paste token tersebut di webchat ini dan kirimkan kepada kami.",
              "type": "text",
              "text_setting": {
                "type": "text",
                "source": "previous_node"
    ...
    },
    {
      ...
      "type": "http-request",
      "position": {
        "x": -142.86110949746063,
        "y": 336.1666666666667
      },
      "properties": {
        "url": "https://clinic-assistant-zeta.vercel.app/api/auth/email",
        "body": [],
        "label": "Check Email",
        "method": "GET",
        "headers": {
        ...
        "variables": [
          {
            ...
            "data_type": "string",
            "persist": true,
            "var_value": "{{node_output.response_body.email}}"
          },
          {
            "var_key": "client_message",
            "data_type": "string",
            "persist": false,
            "var_value": "{{client_message}}"
          }
        ],
        "decription": "",
        "description": ""
...
4. Buka notepad, _paste_ kode tersebut, lalu _search_ (cari) tulisan `domain-backend-aku.vercel.app`. Ganti tulisan tersebut dengan domain backend Vercel kamu (yang didapatkan dari langkah deploy sebelumnya).
5. Setelah diganti, _copy_ kembali seluruh kode dari notepad. Buka halaman **Workflow** di dashboard bot (lewat _sidebar_ sebelah kiri), klik kanan di area kosong pada _canvas_, lalu pilih **Paste**. Selanjutnya, di bawah node **Start** ada icon `+`, _drag_ (tarik) garis dari situ dan sambungkan ke node **Set User Variable** yang posisinya paling atas.
...
Berikut adalah tampilan _workflow_ setelah berhasil di-_import_ ke _canvas_:
![Workflow Node](/public/images/workflow_node.png)

### Coba Langsung (Live Demo)

Ingin melihat cara kerjanya secara langsung? Kamu bisa mencoba berinteraksi dengan Chatbot Clinic Assistant melalui _link_ berikut:
[Coba Chatbot di Sini chat.botika.online](https://chat.botika.online/v3/1PZhYGi)

### Cuplikan Penggunaan Chatbot

Berikut adalah beberapa tangkapan layar (_screenshot_) interaksi dari fitur-fitur utama yang tersedia pada Chatbot Clinic Assistant:
